"""Anonymize raw voice data files from TIM Brazil.

Frequency: Hourly incremental extraction for the previous hour.

Inputs:
    S3: timbrazil-internal/ocs/ocs_moc/y/m/d/h/

Outputs:
    S3: timbrazil-public/ocs/ocs_moc/y/m/d/h/
...
dag = DAG('timbrazil.anonymize_voice',
